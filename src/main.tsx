  ...
  return (
    <div className="app">
      ...
      <main>
        ...
        <section className="cta">
          ...
          <div className="buttons">
            <a href="https://github.com/TortoiseWolfe/001_Template" className="button">
              View on GitHub
            </a>
            <a href="https://github.com/TortoiseWolfe/001_Template/blob/main/TEMPLATE_README.md" className="button secondary">
              Read Documentation
            </a>
          </div>
        </section>
      ...
      <footer>
        ...
        <p>Template abstracted from <a href="https://github.com/TortoiseWolfe/Resume">TortoiseWolfe/Resume</a></p>
      </footer>
    </div>
  );
};
